            ...
            <div className="container">
                ...
                <div className="row mt-4">
                    <div className="col-sm-6 col-md-3">
                        <div className="card">
                            <Image src={ourteam01} alt="Our Team" className="img-fluid" />
                    ...
                    <div className="col-sm-6 col-md-3">
                        <div className="card">
                            <Image src={ourteam02} alt="Our Team" className="img-fluid" />
                            <div className="card-body">
                    ...
                    <div className="col-sm-6 col-md-3">
                        <div className="card">
                            <Image src={ourteam03} alt="Our Team" className="img-fluid" />
                            <div className="card-body">
                    ...
                    <div className="col-sm-6 col-md-3">
                        <div className="card">
                            <Image src={ourteam04} alt="Our Team" className="img-fluid" />
                            <div className="card-body">

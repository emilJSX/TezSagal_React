...
//components
import BlogListSearch from "../search/search";
import LastestBlog from "../lastestblog/lastestblog";
						...
						<div className="col-lg-8 col-md-12">
							<div className="blog">
								<div className="blog-image">
									<Link href="blog-details"><Image className="img-fluid" src={IMG01} alt="Post" /></Link>
								</div>
								<h3 className="blog-title"><Link href="blog-details">Doccure – Making your clinic painless visit?</Link></h3>
								<div className="blog-info clearfix">
									<div className="post-left">
										<ul>
											<li>
												<div className="post-author">
													<Link href="/patient/doctor-profile"><Image src={IMG_th01} alt="Post Author" /> 
							...
							<div className="blog">
								<div className="blog-image">
									<Link href="/blog/blog-details"><Image className="img-fluid" src={IMG02} alt="" /></Link>
								</div>
								...
								<div className="blog-info clearfix">
									<div className="post-left">
										<ul>
											<li>
												<div className="post-author">
													<Link href="/doctor-profile"><Image src={IMG_th02} alt="Post Author" /> 
								...
								<div className="blog-info clearfix">
									<div className="post-left">
										<ul>
											<li>
												<div className="post-author">
													<Link href="/doctor-profile"><Image src={IMG_th03} alt="Post Author" /> 
									...
									<div className="blog-pagination">
										<nav>
											<ul className="pagination justify-content-center">
												...
												<li className="page-item">
												<Link href="#0" className="page-link"><i className="fas fa-angle-double-right"></i></Link>
												</li>
											</ul>
										</nav>
									</div>

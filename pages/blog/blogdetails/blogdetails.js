...
//images
import { IMG01, IMG02, IMG03, IMG04, IMG05, IMG06, IMG07 } from "./img";
//components
                ...
                <div className="blog-view">
                  <div className="blog blog-single-post">
                    <div className="blog-image">
                      <Link href="#0">
                        <Image alt="" src={IMG01} className="img-fluid" />
                      </Link>
                    </div>
                          ...
                          <li>
                            <div className="post-author">
                              <Link href="/patient/doctor-profile">
                                <Image src={IMG02} alt="Post Author" />
                    ...
                    <div className="card-body pb-0">
                      <ul className="comments-list">
                        <li>
                          <div className="comment">
                            <div className="comment-author">
                              <Image className="avatar" alt="" src={IMG04} />
                            </div>
                          ...
                          <ul className="comments-list reply">
                            <li>
                              <div className="comment">
                                <div className="comment-author">
                                  <Image className="avatar" alt="" src={IMG05} />
                                </div>
                                <div className="comment-block">
                                  <span className="comment-by">
                                    <span className="blog-author-name">
                            ...
                            <li>
                              <div className="comment">
                                <div className="comment-author">
                                  <Image className="avatar" alt="" src={IMG06} />
                                </div>
                                <div className="comment-block">
                                  <span className="comment-by">
                                    <span className="blog-author-name">
                        ...
                        <li>
                          <div className="comment">
                            <div className="comment-author">
                              <Image className="avatar" alt="" src={IMG07} />
                            </div>
                            <div className="comment-block">
                              <span className="comment-by">
                                <span className="blog-author-name">

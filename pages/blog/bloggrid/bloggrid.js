                ...
                <div className="row blog-grid-row">
                    ...
                    <div className="blog grid-blog">
                      <div className="blog-image">
                        <Link href="/blog/blog-details">
                          <Image className="img-fluid" src={IMG01} alt="Post" />
                        </Link>
                      </div>
                          ...
                          <li>
                            <div className="post-author">
                              <Link href="/doctor-profile">
                                <Image src={IMG_th01} alt="Post Author" />
                  ...
                  <div className="col-md-6 col-sm-12">
                    <div className="blog grid-blog">
                      <div className="blog-image">
                        <Link href="/blog/blog-details">
                          <Image className="img-fluid" src={IMG02} alt="Post" />
                        </Link>
                      </div>
                      <div className="blog-content">
                        <ul className="entry-meta meta-item">
                          <li>
                            <div className="post-author">
                              <Link href="/doctor-profile">
                                <Image src={IMG_th02} alt="Post Author" />
                  ...
                  <div className="col-md-6 col-sm-12">
                    <div className="blog grid-blog">
                      <div className="blog-image">
                        <Link href="/blog/blog-details">
                          <Image className="img-fluid" src={IMG03} alt="Post" />
                        </Link>
                      </div>
                      <div className="blog-content">
                        <ul className="entry-meta meta-item">
                          <li>
                            <div className="post-author">
                              <Link href="/doctor-profile">
                                <Image src={IMG_th03} alt="Post Author" />
                  ...
                  <div className="col-md-6 col-sm-12">
                    <div className="blog grid-blog">
                      <div className="blog-image">
                        <Link href="/blog/blog-details">
                          <Image className="img-fluid" src={IMG04} alt="Post" />
                        </Link>
                      </div>
                      <div className="blog-content">
                        <ul className="entry-meta meta-item">
                          <li>
                            <div className="post-author">
                              <Link href="/doctor-profile">
                                <Image src={IMG_th04} alt="Post Author" />
                  ...
                  <div className="col-md-6 col-sm-12">
                    <div className="blog grid-blog">
                      <div className="blog-image">
                        <Link href="/blog/blog-details">
                          <Image className="img-fluid" src={IMG05} alt="Post" />
                        </Link>
                      </div>
                      <div className="blog-content">
                        <ul className="entry-meta meta-item">
                          <li>
                            <div className="post-author">
                              <Link href="/doctor-profile">
                                <Image src={IMG_th05} alt="Post Author" />
                  ...
                  <div className="col-md-6 col-sm-12">
                    <div className="blog grid-blog">
                      <div className="blog-image">
                        <Link href="/blog/blog-details">
                          <Image className="img-fluid" src={IMG06} alt="Post" />
                        </Link>
                      </div>
                      <div className="blog-content">
                        <ul className="entry-meta meta-item">
                          <li>
                            <div className="post-author">
                              <Link href="/doctor-profile">
                                <Image src={IMG_th06} alt="Post Author" />
                                <span>Dr. Marvin Campbell</span>
                              </Link>
                            </div>
                          </li>
